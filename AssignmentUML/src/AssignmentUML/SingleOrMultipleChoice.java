...
public class SingleOrMultipleChoice extends QuizBaseClass
{
	public SingleOrMultipleChoice(int quizCode, LinkedHashSet<String> questions, List<List<String>> answers) 
	{
